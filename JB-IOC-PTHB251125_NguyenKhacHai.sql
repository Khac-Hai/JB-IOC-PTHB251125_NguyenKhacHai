...
-- Thêm dữ liệu bảng Payment
insert into Payment(booking_id,payment_method, payment_date, payment_amount)
VALUES(1,'Cash','2025-03-05','400.0'),
      (2,'Credit Cash','2025-03-05','600.0'),
      (3,'Bank Transfer','2025-03-05','1000.0'),
      (4,'Cash','2025-03-05','480.0'),
      (5,'Credit Cash','2025-03-05','800.0');
...
order by sum(P.payment_amount) asc ;
...
select c.customer_id,c.customer_full_name,count(distinct room_id)
from Customer c join Booking B on c.customer_id = B.customer_id
...
$$;
call add_customer(p_customer_id := 'C006',p_customer_full_name := 'Nguyen Khac Hai',p_customer_email := 'haikhac231224@gmail.com',p_customer_phone := '0333341234',p_customer_address := 'Hanoi, Vietnam');
